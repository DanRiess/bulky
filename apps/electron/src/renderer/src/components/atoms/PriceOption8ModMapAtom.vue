<template>
	<li class="a-map-price-option">
		<div class="map">{{ type }}</div>
		<div class="dash">&mdash;</div>
		<div class="quant">Amount: {{ amount }}</div>
		<div class="dash">&ndash;</div>
		<LabelWithNumberInput v-model="model" :step="1">Base Price:</LabelWithNumberInput>
		<div class="chaos">
...
// PROPS
defineProps<{
	type: '8 Mod Maps' | '8 Mod Delirious' | '8 Mod Originator' | '8 Mod Deli + Originator'
	amount: number
}>()
</script>
