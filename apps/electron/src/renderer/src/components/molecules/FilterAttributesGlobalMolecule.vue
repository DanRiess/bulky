<template>
  <div class="m-global-filters">
    <div class="default-filters">
      ...
      <LabelWithCheckboxMolecule
        v-model="filter.alwaysMaxQuantity"
      ...
      <LabelWithCheckboxMolecule
        v-if="filter.delirious !== undefined"
        v-model="filter.delirious"
      >
        Has Delirium Layers:
      </LabelWithCheckboxMolecule>
      <LabelWithCheckboxMolecule
        v-if="filter.originator !== undefined"
        v-model="filter.originator"
      >
        Is Originator influenced:
      </LabelWithCheckboxMolecule>
    </div>
    <div class="regex-filter">
      <LabelWithTextMolecule
        v-if="filter.regex !== undefined"
