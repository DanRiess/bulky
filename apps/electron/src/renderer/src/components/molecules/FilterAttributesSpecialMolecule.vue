<template>
	<AccordionTransitionWrapperAtom :expanded="!filter.fullBuyout">
		...
		<div class="filters flow">
			<FilterFieldHeaderMolecule main-option-name="Modifier" secondary-option-name="Type" key="header" />
			<TransitionAtom :group="true" v-on="hooks">
				<FilterFieldMolecule
					...
					v-model:amountModel="field.amount"
					v-model:maxBuyoutModel="field.maxBuyout"
